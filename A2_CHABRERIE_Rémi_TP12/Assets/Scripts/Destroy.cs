...
public class Destroy : MonoBehaviour
{
    ...
    void Update()
    {
        if (transform.position.z + 30 < player.transform.position.z)                //If the Y position of the crate or the barrier is behind the Y position of the player with an offset of 20
